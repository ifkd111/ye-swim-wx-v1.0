...
npm run ci:upload-function -- --key=D:\ye-swim\ye-swim-private-backup\private.wx7f2d509804954eaf.key --env=cloudbase-d6ge373q7724bcfe4
npm run ci:quality
```

当前 `1.0.10` 使用真实微信云开发环境；远端 GitHub 和 tag 按发布记录同步。
